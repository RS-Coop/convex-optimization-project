...
# ARC with subsampling and various subproblem solvers
def SCR(w, loss, gradient, Hv=None, hessian=None, X=None, Y=None, opt=None,**kwargs):
    ...
    **kwargs : dict, optional
    ...
    # Basics
    eta_1 = opt.get('success_threshold',0.1)
    eta_2 = opt.get('very_success_threshold',0.9)
    ...
    # Subproblem
    subproblem_solver= opt.get('subproblem_solver_SCR','lanczos')
